...
struct SPIFlashHead { // Р·Р°РіРѕР»РѕРІРѕРє flash (РёСЃРїРѕР»СЊР·СѓРµС‚ Р·Р°РіСЂСѓР·С‡РёРє BIOS)
	uint8 id; // = 0xE9
...
struct SPIFlashHeader { // РїРѕР»РЅС‹Р№ Р·Р°РіРѕР»РѕРІРѕРє flash (РёСЃРїРѕР»СЊР·СѓРµС‚ Р·Р°РіСЂСѓР·С‡РёРє BIOS)
...
SpiFlashOpResult SPIEraseArea(uint32_t start_addr, size_t lenght); // bag!
