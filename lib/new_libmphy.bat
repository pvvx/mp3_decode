...
C:\Espressif\xtensa-lx106-elf\bin\xtensa-lx106-elf-ar ru ..\libmphy.a phy_chip_v5_ana_romfunc.o phy_chip_v5_cal_romfunc.o phy_chip_v5_romfunc.o phy.o phy_chip_v6.o phy_chip_v6_ana.o phy_chip_v6_cal.o phy_sleep.o
cd ..
rd /q /s libphy.lib
